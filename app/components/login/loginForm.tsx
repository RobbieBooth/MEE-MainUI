...
export function LoginForm({
    ...
    const consent_URL = import.meta.env.VITE_CONSENT_FORM_URL ?? "#";
    const PIS_URL = import.meta.env.VITE_PIS_FORM_URL ?? "#";
    ...
    return (
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            ...
            <div
                ...
                By clicking continue, you agree to our ethics <a href={consent_URL} target="_blank" title="Consent Form">Consent Form</a>{" "}
                and <a href={PIS_URL} target="_blank" title="Participant Information Sheet">Participant Information Sheet</a>.
            </div>
        </div>
    )
}
